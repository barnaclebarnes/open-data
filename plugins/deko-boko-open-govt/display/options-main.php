...
<div class="wrap">
    <div style="float: right; font-weight: bold; margin-top: 15px;">
        ...
        <input type="image" src="https://www.paypal.com/en_US/i/btn/btn_donate_SM.gif" border="0" name="submit" alt="<?php _e("Support Deko Boko", DEKOBOKO_L10N_NAME); ?>" title="<?php _e("Support Deko Boko", DEKOBOKO_L10N_NAME); ?>" style="vertical-align: middle;" />
    ...
    <tr valign="top">
    <td nowrap="nowrap">reCAPTCHA public key:</td>
    ...
    <tr valign="top">
    <td nowrap="nowrap">Email subject line:</td>
    ...
    <tr valign="top">
    <td nowrap="nowrap">Welcome message:</td>
    ...
    <tr valign="top">
    <td nowrap="nowrap">Success message:</td>
    ...
    <tr valign="top">
    <td nowrap="nowrap">"CC Me" header:</td>
    ...
    <tr valign="top">
    <td nowrap="nowrap">"CC Me" footer:</td>
    ...
    <tr valign="top">
    <td nowrap="nowrap">Page Slugs/IDs:</td>
    ...
    <tr valign="top">
    <td nowrap="nowrap">reCAPTCHA theme:</td>
    ...
    <tr valign="top">
    <td nowrap="nowrap">reCAPTCHA language:</td>
    <td nowrap="nowrap"><select name="dekoboko_options[recaptcha_lang]">
        <option value="en" <?php if ($dekoboko_options['lang'] == 'en') echo 'selected="selected"'; ?>><?php _e('English', DEKOBOKO_L10N_NAME); ?></option>
        <option value="nl" <?php if ($dekoboko_options['lang'] == 'nl') echo 'selected="selected"'; ?>><?php _e('Dutch', DEKOBOKO_L10N_NAME); ?></option>
        <option value="fr" <?php if ($dekoboko_options['lang'] == 'fr') echo 'selected="selected"'; ?>><?php _e('French', DEKOBOKO_L10N_NAME); ?></option>
        <option value="de" <?php if ($dekoboko_options['lang'] == 'de') echo 'selected="selected"'; ?>><?php _e('German', DEKOBOKO_L10N_NAME); ?></option>
        <option value="pt" <?php if ($dekoboko_options['lang'] == 'pt') echo 'selected="selected"'; ?>><?php _e('Portuguese', DEKOBOKO_L10N_NAME); ?></option>
        <option value="ru" <?php if ($dekoboko_options['lang'] == 'ru') echo 'selected="selected"'; ?>><?php _e('Russian', DEKOBOKO_L10N_NAME); ?></option>
        <option value="es" <?php if ($dekoboko_options['lang'] == 'es') echo 'selected="selected"'; ?>><?php _e('Spanish', DEKOBOKO_L10N_NAME); ?></option>
        <option value="tr" <?php if ($dekoboko_options['lang'] == 'tr') echo 'selected="selected"'; ?>><?php _e('Turkish', DEKOBOKO_L10N_NAME); ?></option>
    </select></td>
    <td>&nbsp;</td>
    </tr>
    </table>
